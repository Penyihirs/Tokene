...
vipro.text = "Invite Juga Wizard II Kesini ^_^"
...
this.command('Halo', ['halo disini Wizard','kamu siapa?']);
this.command('Hi', ['hi disini Wizard','kamu siapa?']);

this.command('Wizard', ['Apa kak? ada yg bisa dibantu?','Ketik /help untuk bantuan']);
